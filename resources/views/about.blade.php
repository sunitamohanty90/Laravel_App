...
<div class="flex justify-center items-center">  
   <div class="flex flex-col bg-white p-8 rounded-xl">
      ...
      <form action="{{ route('aboutdetails') }}" method="post" enctype="multipart/form-data">
         @csrf
         ...
         @endif
        <div>
          <h2 class="text-blue-600 text-3xl font-weight-800">About</h2>
          
            <div class="flex flex-col p-4 rounded-xl w-96">
                 <label for="text">Work</label>
                 <textarea  class="px-4 h-32 my-2 border border-1 border-gray-300 rounded-xl" name="work" placeholder="work.." value="{{ old('work')}}" ></textarea>
                 ...
                 <button class=" bg-blue-600 hover:bg-blue-700 text-white my-2 py-1 rounded-xl w-80" type="submit">Create</button>
